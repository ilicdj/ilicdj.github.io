...
`].filter(Tr).join(`
`)),a=_o(a),a=nc(a,e),a=ic(a,e),o=_o(o),o=nc(o,e),o=ic(o,e),a=rc(a),o=rc(o),e.isRawShaderMaterial!==!0&&(y=`#version 300 es
...
void main() {\r
  ...
  gl_FragColor = color;\r
    ...
    uniform float progress;
      ...
      p += 0.1 * cos( scale * 3.7 * p.yx + .2 * time + vec2(2.2,3.4) ); 
      p += 0.1 * cos( scale * 5. * p.yx + 0.8 * time + vec2(4.2,1.4) );
      p += 0.3 * cos( scale * 7. * p.yx + 1. * time + vec2(10.2,3.4) );
      p += 0.1 * cos( scale * 1. * p.yx + .1 * time + vec2(4.2,3.4) );


      // Interesantno
      // p += 0.1 * cos( scale * 3. * p.yx + time + vec2(1.2,3.4) ); 
      // p += 2.1 * cos( scale * 3.7 * p.yx + .2 * time + vec2(2.2,3.4) ); 
      // p += 10.1 * cos( scale * 5. * p.yx + 0.8 * time + vec2(4.2,1.4) );
      // p += 0.3 * cos( scale * 7. * p.yx + 1. * time + vec2(10.2,3.4) );
      // p += 0.1 * cos( scale * 1. * p.yx + .1 * time + vec2(4.2,3.4) );
